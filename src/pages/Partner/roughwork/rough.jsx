...
// 	);
// 	// const watchPrimaryContact = watch('primary_contact');
// 	// const watchSecondaryContact = watch('secondary_contact');
// 	// const contactArr = [];

// 	// useEffect(() => {
// 	// 	if (watchSecondaryContact !== '')
// 	// 		contactArr.push(parseInt(watchPrimaryContact, 10));
// 	// 	const result = contactArr.includes(parseInt(watchSecondaryContact, 10));
// 	// 	if (!isEdit || result) {
// 	// 		setList([
// 	// 			{
// 	// 				id: 1,
// 	// 				title: 'ALREADY EXIST',
// 	// 				description: 'Mobile Number is Already Exist',
...
// 	// 	// setUniqueContact(contactArr);
// 	// }, [watchSecondaryContact]);
// 	useEffect(() => {
...
// 		navigate(-1);
// 	};
// 	useEffect(() => {}, [shopImagesFireBaseUrl]);
// 	useEffect(() => {
// 		const data = {
// 			data: {},
// 			method: 'get',
...
// 		// setMultiImageCount(multiImage?.length);
// 		setList([
// 			{
// 				id: 1,
// 				title: 'FILE UPLOAD',
...
// 		setAbleToGetLogoUrl(true);
// 		// eslint-disable-next-line no-unused-vars
// 		// Object.entries(multiImage)?.map(async ([key, value]) => {
// 		// 	const imageRef = ref(storage, `images/${value.name}`);
// 		// 	try {
// 		// 		await uploadBytes(imageRef).then(() => {
// 		// 			setShopImagesName(value.name);
// 		// 		});
// 		// 	} catch {
// 		// 		alert('Image upload failed try again!!');
// 		// 	}
...
// 	// useEffect(() => {
// 	// 	// eslint-disable-next-line no-unused-vars
// 	// 	if (logoName?.length && ableToGetLogoUrl) {
// 	// 		getDownloadURL(ref(storage, `images/${logoName}`))
// 	// 			.then((url) => {
// 	// 				setLogoFireBaseurl(url);
// 	// 				setTimeout(() => {
// 	// 					setAbleToGetLogoUrl(false);
// 	// 				});
// 	// 			})
// 	// 			.catch((error) => {
// 	// 				alert('Image upload failed try again!!', error);
// 	// 			});
// 	// 	}
// 	// }, [ableToGetLogoUrl, logoName]);

// 	// useEffect(() => {
// 	// 	const getDownloadURLs = async (name) => {
// 	// 		getDownloadURL(ref(storage, `images/${name}`))
// 	// 			.then((url) => {
// 	// 				setShopImagesFireBaseUrl((current) => [...current, url]);
// 	// 				setTimeout(() => {
// 	// 					setAbleToGetLogoUrl(false);
// 	// 				});
// 	// 			})
...
// 	// 	};
// 	// 	// eslint-disable-next-line no-unused-vars
// 	// 	if (shopImagesName.length && ableToGetLogoUrl) {
// 	// 		getDownloadURLs(shopImagesName);
// 	// 	}
// 	// }, [ableToGetLogoUrl, shopImagesName]);
...
// 			// formData.append('type_of_store', JSON.stringify(values));

// 			// finalData.shop_images = shopImagesFireBaseUrl;
// 			// finalData.shop_logo = logoFireBaseurl;
// 			// finalData.type_of_store = values;
// 			const submitData = {
// 				data: formData,
// 				method: 'post',
